  ...
  const amrex::Real* probhi)
{
  ...
  eos.PYT2RE(
    PeleC::h_prob_parm_device->p, PeleC::h_prob_parm_device->massfrac.begin(), PeleC::h_prob_parm_device->T0,
    PeleC::h_prob_parm_device->rho0, PeleC::h_prob_parm_device->eint0);
  eos.RTY2Cs(
    PeleC::h_prob_parm_device->rho0, PeleC::h_prob_parm_device->T0, PeleC::h_prob_parm_device->massfrac.begin(),
    cs);
  eos.TY2Cp(PeleC::h_prob_parm_device->T0, PeleC::h_prob_parm_device->massfrac.begin(), cp);
