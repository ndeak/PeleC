  ...
  const amrex_real* probhi)
{
  ...
  pp.query("r0", PeleC::h_prob_parm_device->r0);
  pp.query("Ld", PeleC::h_prob_parm_device->Ld);
  pp.query("y0", PeleC::h_prob_parm_device->y0);
  pp.query("sigma0", PeleC::h_prob_parm_device->sigma0);
  pp.query("Erho", PeleC::h_prob_parm_device->Erho);
  pp.query("Econst", PeleC::h_prob_parm_device->Econst);
  ...
  PeleC::h_prob_parm_device->massfrac[O2_ID] = 0.21;
  PeleC::h_prob_parm_device->massfrac[N2_ID] = 0.79;
