...
def plotGap(pltfile,field,logbool,xyedge,cmapvar,zlims,gridson):
    ...
    plotgrids = True
    minGridLevel = 2
    clocation = [xyedge[0]-0.15 ,0.25 ,xyedge[1]-0.0000001]
    ...
    ds.field_list
    sl = yt.SlicePlot(ds,cutplane,field,center=clocation,width=[0.3,0.5],fontsize=20,origin='center-right-window',data_source=no_pin,buff_size=[3000,3000])
